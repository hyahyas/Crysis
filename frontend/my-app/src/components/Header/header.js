            ...
            <div className={`bg-${'gray-900'} text-white p-4`}>
                ...
                <img
                    ...
                    <div className="flex space-x-4">
                        ...
                        <button onClick={handleLogout} className={`bg-red-500 px-4 py-2 rounded-md ${'dark:bg-red-600'}`}>
                            Logout
                        </button>
                        <button onClick={handleHomeClick} className={`bg-red-500 px-4 py-2 rounded-md ${'dark:bg-red-600'}`}>
